  ...
  <div class="container">
    <div class="game-container">
      ...
      <div class="boxes-grid gifts-grid">
        <?php for ($i = 1; $i <= 12; $i++): ?>
          <button class="box gift" data-id="<?= $i ?>" data-idx="<?= $i ?>" data-img="images/regalo<?= $i ?>.png" type="button">
...
<footer>
  <div class="container">
    <div class="footer-content">
      ...
      <div class="footer-section">
        <h3>Contáctanos</h3>
    <!--<p><i class="fas fa-map-marker-alt"></i> Cra 29 # 69-57, Manizales - Caldas - Colombia</p>-->
        <p><i class="fas fa-phone"></i> +1 (551) 306-9144</p>
        <p><i class="fas fa-envelope"></i> bloomspa1594@gmail.com</p>
      </div>
      <div class="footer-section">
      ...
      <div class="footer-section">
        ...
        <div class="social-icons">
          <a href="https://www.facebook.com/Bloomspa94?mibextid=eHce3h"><i class="fab fa-facebook"></i></a>
          <a href="https://www.instagram.com/bloomspa94/"><i class="fab fa-instagram"></i></a>
          <a href="https://api.whatsapp.com/send?phone=15513069144"><i class="fab fa-whatsapp"></i></a>
