...
<section class="admin-section">
  ...
  <?php if ($flash): ?>
    <div class="flash <?= esc($flash['type']) ?>" style="
      margin:12px 0;padding:10px 14px;border-radius:8px;
      border:1px solid <?= $flash['type']==='success' ? '#bde5c8' : '#f5b5b5' ?>;
      background:<?= $flash['type']==='success' ? '#eafaf0' : '#fdecec' ?>;
      color:<?= $flash['type']==='success' ? '#0f8a3e' : '#c1272d' ?>;">
      <?= esc($flash['msg']) ?>
    </div>
  <?php endif; ?>
  <div class="container">
